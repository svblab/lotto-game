...
/**
 * GameTurnService — EPIC-24.0 (ADR-015)
 *
 * Turn/draw cluster extracted from GameService (move-only refactor).
 */
final class GameTurnService
{
    ...
    /**
     * Post-construction wiring (ADR-008 pattern, same as GameService).
     */
