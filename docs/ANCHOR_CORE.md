...
Deploy (generic systemd multi-instance, new VPS): `deploy/systemd/` — B1 foundation + B2 install (`install.sh`); remove/update deferred (B3/C); see `deploy/systemd/README.md`.
