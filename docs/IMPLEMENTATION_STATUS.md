...
- [DONE] **EPIC-17** — canonical install `@ b3531d1` on VPS — `docs/EPIC_17_PRODUCTION_DEPLOYMENT.md`
- [DONE] **G1/G2/G3/G5** evidence on production VPS @ `b3531d1` (see EPIC-17 report)
- [PENDING] G4 browser E2E, G6–G11
